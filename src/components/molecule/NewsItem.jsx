...
const NewsItem = ({blogId, imagePath, title, description, publishDate}) => <StyledNewsItem>
    <Thumbnail src={imagePath}/>
    <Title>{title}</Title>
    <Description>{description}</Description>
    <ButtonLink to={`/blog/${blogId}`} hasUnderline={false}><ReadMoreButton>もっと読む</ReadMoreButton></ButtonLink>
</StyledNewsItem>
